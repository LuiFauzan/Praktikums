    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-4 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="mb-4 overflow-auto" x-data="{ openModal: false }">
                    <!-- Tombol untuk Membuka Modal -->
                    <button x-on:click="openModal = true" class="p-2 bg-slate-200 hover:bg-slate-300 rounded-md text-sm">
                        <i class="fas fa-calendar-plus"></i> Tambah Jadwal Praktikum
                    </button>
                
                    <!-- Modal untuk Form Tambah Jadwal Praktikum -->
                    <div x-show="openModal" x-on:keydown.escape.window="openModal = false" class="fixed top-0 left-0 w-full h-full py-10 px-10 bg-black bg-opacity-50 flex justify-center items-center">
                        <!-- Modal Content -->
                        <div class="bg-white overflow-y-auto rounded-lg p-8 max-w-3xl h-screen w-full">
                            ...
                            <form method="POST" action="{{ route('jadwalpraktikum.store') }}" class="grid grid-cols-2 gap-x-4">
                                @csrf
                                <!-- Hari -->
                                ...
                                <div class="col-span-2">
                                    ...
                                    <x-text-input id="jammulai" class="block mt-1 w-full" type="time" name="jammulai" :value="old('jammulai')" required />
                                ...
                                <div class="col-span-2">
                                    ...
                                    <x-text-input id="jamberes" class="block mt-1 w-full" type="time" name="jamberes" :value="old('jamberes')" required />
